...
//   WorkplaceHazards({this.environmentID, this.workplaceHazard, this.hazards});
//
//   // final String industryID;
//   final String environmentID;
//   final workplaceHazard;
//   final hazards;
//
//   @override
...
//                         //             hazardCategory.reference.collection('hazard_category').snapshots()));
//                         //       }
//                         //
//                         //       return Column(
...
//   // HazardDropdown(hazardType, stream) {
//   HazardDropdown(hazardType) {
                  ...
                  children: [
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          padding: const EdgeInsets.all(20.0),
                          child: HazardDropdown('Ergonomic Hazards'),
                        ),
                        StreamBuilder<QuerySnapshot>(
                          stream: _firestore
                              .collection('industry')
