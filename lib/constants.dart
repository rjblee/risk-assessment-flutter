...
// Colours
const kSISColour = Color(0XFFB5121B);
const kAppDark = Color(0XFF0C0F1E);
const kAppLight = Color(0XFFDCD6DA);
const kAppBlue = Color(0XFF08A1FA);
const kAppGreen = Color(0XFFD7FF61);
const kSISRed = Color(0XFFC40212);
const kSISBrown = Color(0XFF523C30);

const kResultLow = Color(0XFFb6ff5c);
const kResultMedium = Color(0XFFffbe33);
const kResultHigh = Color(0XFFe43a48);
